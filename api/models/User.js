module.exports = {
    attributes: {
        ...
        coverUrl: {type: 'string', defaultsTo: 'images/congress.jpg'},
        ...
        isOfficial: {type: 'boolean', defaultsTo: false},
        isVerified: {type: 'boolean', defaultsTo: false},
        socialAccounts: {type: 'json'},
        party: {type: 'string'},
        state: {type: 'json'},
        ...
        bills: {collection: 'billmember', via: 'user'},
        committees: {collection: 'committeemember', via: 'user'},
        bioguide_id:{type: 'string'},
        leg_id:{type: 'string'},
        representatives: {collection: 'representative', via: 'constituent'},
        constituents: {collection: 'representative', via: 'representative'},
        committeeCount: {type: 'integer', defaultsTo: 0},
        constituentCount: {type: 'integer', defaultsTo: 0},
        representativeCount: {type: 'integer', defaultsTo: 0},
        voteCount: {type: 'integer', defaultsTo: 0},
        passports: {collection: 'Passport', via: 'user'},
        passwordResetToken: {type: 'string'},
        resetTokenExpiresAfter: {type: 'integer'}
    },
