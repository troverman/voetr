...
angular.module("about/index.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("about/index.tpl.html",
    ...
    "    <video class=\"flexible\" autoplay=\"autoplay\" muted=\"muted\" preload=\"auto\" loop=\"loop\">\n" +
    "        <source src=\"https://s3-us-west-2.amazonaws.com/voetr/washington.mp4\" type=\"video/mp4\">\n" +
    "    </video>\n" +
    "    <div class=\"imageContainerDiv\">\n" +
    "        <div class=\"intro-text\">\n" +
    "            <h1 class=\"light vBlue\">foster empowerment, change consensus</h1>\n" +
    "            <h1><b>are they listening?</b></h1>\n" +
    "        </div>\n" +
    "    </div>\n" +
    "</div>\n" +
    "<!--\n" +
...
angular.module("intro/index.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("intro/index.tpl.html",
    ...
    "            <h1><b>are they listening?</b></h1>\n" +
    "            <div class=\"btn-cont\">\n" +
    "                <a class=\"btn\" href=\"#about\" du-smooth-scroll>\n" +
    "                    Talk Louder\n" +
...
angular.module("login/index.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("login/index.tpl.html",
    ...
    "            <input placeholder=\"username\" title=\"username\" type=\"text\"> \n" +
    "            <input placeholder=\"password\" title=\"username\" type=\"password\"> \n" +
    "            <button class=\"btn\" type=\"submit\">sign in</button> \n" +
    "            <a class=\"already\" href=\"/register\">register an account</a>\n" +
    "        </form>\n" +
    "    </div>\n" +
    "</div>\n" +
    "\n" +
...
angular.module("nav/index.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("nav/index.tpl.html",
    "<style>\n" +
    ".navbar-inverse{background-color:rgb(26,26,26);}\n" +
    "</style>\n" +
    "<nav ng-controller=\"NavCtrl\" class=\"navbar navbar-inverse navbar-fixed-top\">\n" +
    "  <div class=\"container\">\n" +
    ...
    "          <div class=\"form-group\">\n" +
    "            <input ng-keyup=\"keyPress(searchValue)\" ng-model=\"searchValue\" id=\"search-link\" size=\"40\" type=\"text\" placeholder=\" Search (Locations, Reps, etc.) \">\n" +
    "          </div>\n" +
    "        </form>\n" +
...
angular.module("register/index.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("register/index.tpl.html",
    ...
    "                <a class=\"already\" href=\"/login\">have an account?</a>\n" +
    "            </form>\n" +
    "        </div>\n" +
    "    </div>\n" +
    "</div>\n" +
